...
/* harmony default export */ var BaseInputDatevue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    this.year = "".concat(this.value ? new Date(this.value).getFullYear() : ""); // if (this.value.length === 10) {
...
var BaseInputDate_component = normalizeComponent(
  ...
  BaseInputDatevue_type_template_id_384c44ea_render,
  BaseInputDatevue_type_template_id_384c44ea_staticRenderFns,
  false,
  null,
  null,
  null
